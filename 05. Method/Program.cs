...
namespace _05._Method
{
	internal class Program
	{
		...
		static int Max3(params int[] values)    // params와 배열을 통해 몇개의 매개변수가 들어와도 대응가능
		{
			return values.Max();
		}
		...
		static void Main3()
		{
			...
			int max1 = Max3(1, 2, 3, 4, 5);     // params 매개변수의 함수는 원하는 만큼의 갯수를 매개변수로 사용
			int max2 = Max3(1, 2);
			int max3 = Max3(1, 2, 3, 4);
		}
